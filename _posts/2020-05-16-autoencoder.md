...
![Yosuha Bengio's slide]({{site.url}}/assets/img/post_img/autoencoder/bengio_slide.png)

- 추가 이미지 
![slide]({{site.url}}/assets/img/post_img/autoencoder/ch1_1.jpg)
![slide]({{site.url}}/assets/img/post_img/autoencoder/ch1_2.jpg)
![slide]({{site.url}}/assets/img/post_img/autoencoder/ch1_3.jpg)
...
![slide]({{site.url}}/assets/img/post_img/autoencoder/gan.jpg)

#### AutoEncoder and VAE

![slide]({{site.url}}/assets/img/post_img/autoencoder/ae.jpg)
![slide]({{site.url}}/assets/img/post_img/autoencoder/vae.jpg)
![slide]({{site.url}}/assets/img/post_img/autoencoder/vae_2.jpg)
![slide]({{site.url}}/assets/img/post_img/autoencoder/vae_3.jpg)

#### AAE 
![slide]({{site.url}}/assets/img/post_img/autoencoder/aae.jpg)
![slide]({{site.url}}/assets/img/post_img/autoencoder/saae.jpg)
